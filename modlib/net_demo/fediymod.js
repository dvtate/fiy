...
// TODO move this to an NPM package
...
const fiy = new FIY('domain.com', express());

// fiy.router is an express.Router instance for the user-facing app paths
fiy.get('/', async (req, res) => {
    // ... action for this router
});
